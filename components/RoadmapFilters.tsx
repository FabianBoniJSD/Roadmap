    ...
    <div className="bg-gray-800/60 border border-gray-700 rounded-xl px-3 md:px-4 py-3">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          {activeCount > 0 && (
            <span className="text-xs px-2 py-0.5 rounded-full bg-black/40 border border-white/10">
              {activeCount}
            </span>
          )}
        </div>
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div className="px-1 py-2 bg-gray-900 border border-gray-700 rounded-lg">
              <div className="flex items-center gap-2 text-xs text-gray-300 mb-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onMonthRangeChange({
                      start: Math.min(Math.max(1, Number(e.target.value) || 1), monthRange.end),
                      end: monthRange.end,
                    })
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    onMonthRangeChange({
                      ...
                      end: Math.max(Math.min(12, Number(e.target.value) || 12), monthRange.start),
                    })
                  }
                  className="w-14 bg-gray-800 border border-gray-700 rounded px-2 py-1"
                />
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    onMonthRangeChange({
                      start: Math.min(Number(e.target.value) || 1, monthRange.end),
                      end: monthRange.end,
                    })
                  }
                  className="w-full"
                ...
                <input
                  ...
                  onChange={(e) =>
                    onMonthRangeChange({
                      start: monthRange.start,
                      end: Math.max(Number(e.target.value) || 12, monthRange.start),
                    })
                  }
                  className="w-full"
                />
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-gray-900 border border-gray-700 rounded-lg px-3 py-2">
              <input
                type="checkbox"
                checked={onlyRunning}
                onChange={(e) => onToggleOnlyRunning(e.target.checked)}
              />
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-gray-900 border border-gray-700 rounded-lg px-3 py-2 text-sm">
              <span className="text-xs text-gray-400">Schnellaktionen</span>
